...
#define ADC_I_Pin GPIO_PIN_0
#define ADC_I_GPIO_Port GPIOC
#define ADC_U_Pin GPIO_PIN_1
#define ADC_U_GPIO_Port GPIOC
#define SBUS_TX_UNUSED_Pin GPIO_PIN_0
#define SBUS_TX_UNUSED_GPIO_Port GPIOA
...
#define IMU_BAR_SCK_Pin GPIO_PIN_5
#define IMU_BAR_SCK_GPIO_Port GPIOA
...
#define ESC_TX_UNUSED_Pin GPIO_PIN_10
#define ESC_TX_UNUSED_GPIO_Port GPIOC
...
#define GEN_SCK_Pin GPIO_PIN_3
#define GEN_SCK_GPIO_Port GPIOB
#define IMU_BAR_MISO_Pin GPIO_PIN_4
#define IMU_BAR_MISO_GPIO_Port GPIOB
#define IMU_BAR_MOSI_Pin GPIO_PIN_5
